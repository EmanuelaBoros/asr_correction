...
import datasets
class ASRDataset(datasets.Dataset):
...
def main():
    ...
    dev_dataset = Dataset(pa.Table.from_pandas(df))
    ...
    def preprocess_function(examples):
        ...
        # import pdb;pdb.set_trace()
        inputs = [ex for ex in examples['HYPOTHESE']]
        targets = [ex for ex in examples['REFERENCE']]
